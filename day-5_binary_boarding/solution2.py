...
for line in file_lines_list:
    ...
    list_of_seat_ids.append(seat_row_dec*8 + seat_no_dec)
    if (seat_row_dec*8 + seat_no_dec) > max_seat_id:  
        max_seat_id = seat_row_dec*8 + seat_no_dec

ideal_seat_id_set = set(number for number in range(26, 963))
actual_seat_id_set = set(list_of_seat_ids)
print(ideal_seat_id_set.difference(actual_seat_id_set))